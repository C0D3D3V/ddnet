...
# Game
container.sprites.Add(Sprite("hud_airjump", set_extras, 0,0,2,2))
container.sprites.Add(Sprite("hud_airjump_empty", set_extras, 2,0,2,2))
container.sprites.Add(Sprite("hud_freeze_bar_full", set_extras, 0,2,4,1))
container.sprites.Add(Sprite("hud_freeze_bar_empty", set_extras, 0,3,4,1))
container.sprites.Add(Sprite("hud_ninja_bar_full", set_extras, 0,2,4,1))
container.sprites.Add(Sprite("hud_ninja_bar_empty", set_extras, 0,3,4,1))
# Icons
container.sprites.Add(Sprite("hud_solo", set_extras, 0,6,2,2))
container.sprites.Add(Sprite("hud_collision_disabled", set_extras, 2,6,2,2))
container.sprites.Add(Sprite("hud_endless_jump", set_extras, 4,6,2,2))
container.sprites.Add(Sprite("hud_endless_hook", set_extras, 6,6,2,2))
container.sprites.Add(Sprite("hud_jetpack", set_extras, 8,6,2,2))
container.sprites.Add(Sprite("hud_teleport_gun", set_extras, 10,6,2,2))
container.sprites.Add(Sprite("hud_teleport_grenade", set_extras, 12,6,2,2))
container.sprites.Add(Sprite("hud_teleport_laser", set_extras, 14,6,2,2))
container.sprites.Add(Sprite("hud_deep_frozen", set_extras, 0,8,2,2))
container.sprites.Add(Sprite("hud_live_frozen", set_extras, 2,8,2,2))
container.sprites.Add(Sprite("hud_hook_hit_disabled", set_extras, 4,8,2,2))
container.sprites.Add(Sprite("hud_hammer_hit_disabled", set_extras, 6,8,2,2))
container.sprites.Add(Sprite("hud_shotgun_hit_disabled", set_extras, 8,8,2,2))
container.sprites.Add(Sprite("hud_grenade_hit_disabled", set_extras, 10,8,2,2))
container.sprites.Add(Sprite("hud_laser_hit_disabled", set_extras, 12,8,2,2))
container.sprites.Add(Sprite("hud_gun_hit_disabled", set_extras, 14,8,2,2))
container.sprites.Add(Sprite("hud_practice_mode", set_extras, 0,10,2,2))
container.sprites.Add(Sprite("hud_dummy_hammer", set_extras, 2,10,2,2))
container.sprites.Add(Sprite("hud_dummy_copy", set_extras, 4,10,2,2))
container.sprites.Add(Sprite("hud_airjump_disabled", set_extras, 6,10,2,2))
# Particles
container.sprites.Add(Sprite("part_snowflake", set_extras, 0,14,2,2))
