...
MACRO_CONFIG_INT(ClShowNinjaBars, cl_show_ninja_bars, 1, 0, 1, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Whether to show a ninja bar under players to indicate the ninja time")
