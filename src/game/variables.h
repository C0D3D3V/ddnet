...
MACRO_CONFIG_INT(ClShowStateChangeCountdown, cl_show_state_change_countdown, 1, 0, 2, CFGFLAG_SAVE | CFGFLAG_CLIENT, "Show a state change countdown under players. As 1 = bar, 2 = stars")
...
MACRO_CONFIG_INT(ClFreezeBarsAlphaOutsideFreeze, cl_freezebars_alpha_outside_freeze, 100, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Opacity of freeze bars outside freeze (0 invisible, 100 fully visible)")
